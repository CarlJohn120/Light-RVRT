...
try:
    ...
    UPFIRD_EXT_AVAILABLE = False
    upfirdn2d_op = None
    print('Warning: upfirdn2d extension not available, using Python fallback.')
...
def upfirdn2d(input, kernel, up=1, down=1, pad=(0, 0)):
    if UPFIRD_EXT_AVAILABLE and upfirdn2d_op is not None:
        out = UpFirDn2d.apply(
